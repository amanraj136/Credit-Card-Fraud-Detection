...
- `best_model_gradient_boosting.pkl` — trained pkl model.
...
- `test_samples/` — Batch test samples in `.csv` format for downloading and testing purposes.


## Notes
- This project is under active development — new experiments and UI updates may follow.
